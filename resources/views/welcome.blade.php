...
<div class="container">
    ...
    <div class="row justify-content-center mb-4">
        <div class="col-md-10">
            <div class="p-5 mb-4 bg-gradient rounded-4 shadow text-center" style="background: linear-gradient(90deg, #ffecd2 0%, #fcb69f 100%); color: #333;">
                ...
                <p class="lead mb-0">Where Convenience Meets the Road</p>
            </div>
        </div>
    </div>
            ...
            <div id="mainCarousel" class="carousel slide shadow rounded-4 overflow-hidden" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="{{ asset('images/car1.png') }}" class="d-block w-100" alt="Car 1">
                    ...
                    <div class="carousel-item">
                        <img src="{{ asset('images/car2.jpg') }}" class="d-block w-100" alt="Car 2">
                        <div class="carousel-caption d-none d-md-block bg-dark bg-opacity-50 rounded-3 p-2">
                    ...
                    <div class="carousel-item">
                        <img src="{{ asset('images/car3.jpg') }}" class="d-block w-100" alt="Car 3">
                        <div class="carousel-caption d-none d-md-block bg-dark bg-opacity-50 rounded-3 p-2">
                ...
                <div class="col-md-4">
                    <div class="card border-0 shadow h-100">
                        <div class="card-body">
                            ...
                            <p class="card-text">Choose from economy, luxury, SUVs, and more to fit your needs.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
    ...
    <div class="row justify-content-center mt-5 mb-4">
        <div class="col-md-10 text-center">
            <a href="{{ route('auth.register') }}" class="btn btn-lg px-5 py-3 shadow" style="background: linear-gradient(90deg, #ffb347 0%, #ffcc33 100%); color: #333; border: none;">
                Get Started Now
            </a>
        </div>
    </div>
